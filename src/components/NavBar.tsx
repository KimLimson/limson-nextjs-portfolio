...
export default function NavBar() {
  ...
  return (
    <nav
      ref={ref}
      className="fixed top-0 inset-x-0 z-50 backdrop-blur border-b border-white/10 bg-black/30"
    >
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
        ...
        <a
          href="#contact"
          className="hidden sm:inline-block rounded-full px-4 py-2 text-sm font-medium bg-cyan-500/20 text-cyan-300 hover:bg-cyan-500/30 border border-cyan-400/30"
        >
          Contact
        </a>
      </div>
